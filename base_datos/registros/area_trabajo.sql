...
-- Tiempo de generación: 05-01-2020 a las 07:22:54
...
CREATE TABLE `area_trabajo` (
  ...
  `nombre_area_trabajo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL
...
ALTER TABLE `area_trabajo`
  ADD PRIMARY KEY (`id_area_trabajo`);
...
--
ALTER TABLE `area_trabajo`
  MODIFY `id_area_trabajo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
